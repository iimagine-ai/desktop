...
const CATEGORY_OPTIONS = [
  ...
  { id: 'image-generation', label: 'Image Gen', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="m15 4-1 1M4 15l1-1"/><path d="m9 5 .5-.5M5 9l-.5.5M14 14l.5-.5"/><rect x="2" y="2" width="20" height="20" rx="2"/></svg>' },
