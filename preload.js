...
contextBridge.exposeInMainWorld('api', {
  ...
  plugins: {
    ...
    isEnabled: (id) => ipcRenderer.invoke('plugins:isEnabled', id),
    ...
    renderPage: (pluginId, activeTab) => ipcRenderer.invoke('plugins:renderPage', pluginId, activeTab),
    ...
    // Cortex memory space management
    setMemorySpace: (groupId) => ipcRenderer.invoke('cortex:setMemorySpace', groupId),
    getMemorySpace: () => ipcRenderer.invoke('cortex:getMemorySpace'),
    getMemorySpaces: () => ipcRenderer.invoke('cortex:getMemorySpaces'),
    createMemorySpace: (data) => ipcRenderer.invoke('cortex:createMemorySpace', data),
    deleteMemorySpace: (data) => ipcRenderer.invoke('cortex:deleteMemorySpace', data),
    renameMemorySpace: (data) => ipcRenderer.invoke('cortex:renameMemorySpace', data),
    // Facts
    getFacts: () => ipcRenderer.invoke('cortex:getFacts'),
    getFactsBudget: () => ipcRenderer.invoke('cortex:getFactsBudget'),
    createFact: (data) => ipcRenderer.invoke('cortex:createFact', data),
    updateFact: (data) => ipcRenderer.invoke('cortex:updateFact', data),
    deleteFact: (data) => ipcRenderer.invoke('cortex:deleteFact', data),
    confirmFact: (data) => ipcRenderer.invoke('cortex:confirmFact', data),
    getStaleFacts: () => ipcRenderer.invoke('cortex:getStaleFacts'),
    resolveStaleFact: (data) => ipcRenderer.invoke('cortex:resolveStaleFact', data),
    getContradictions: () => ipcRenderer.invoke('cortex:getContradictions'),
    acknowledgeFact: (data) => ipcRenderer.invoke('cortex:acknowledgeFact', data),
    // Analytics / Telemetry
    getMetrics: () => ipcRenderer.invoke('cortex:getMetrics'),
    getMetricsHistory: () => ipcRenderer.invoke('cortex:getMetricsHistory'),
    getMetricsFailures: () => ipcRenderer.invoke('cortex:getMetricsFailures'),
    logResponse: (data) => ipcRenderer.invoke('cortex:logResponse', data),
    memoryMiss: (data) => ipcRenderer.invoke('cortex:memoryMiss', data),
    setSetting: (data) => ipcRenderer.invoke('cortex:set-setting', data),
    onModuleCreated: (callback) => ipcRenderer.on('cortex:module-created', (event, data) => callback(data)),
